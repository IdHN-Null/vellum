...
- 소스에서 배포본을 만드는 방법: [`plugin/README.md`](plugin/README.md)의 개발 섹션 참고
- 구조/동작 원리: [`plugin/ARCHITECTURE.md`](plugin/ARCHITECTURE.md)
- 설계 배경: [`plugin/DESIGN-DECISIONS.md`](plugin/DESIGN-DECISIONS.md)
...
자세한 규칙은 [CONTRIBUTING.md](CONTRIBUTING.md)를 꼭 읽어주세요.
